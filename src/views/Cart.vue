            ...
            <ul class="cart-item-list">
              <li v-for="item in cartList" :key="item._id">
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        ...
                        <span class="select-ipt">{{!!item.productNum === true ? item.productNum: 1}}</span>
                ...
                <div class="cart-tab-4">
                  <div class="item-price-total">{{(!!item.productNum === true ? item.productNum: 1) * item.salePrice}}</div>
                </div>
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" :class="{'btn--dis': checkedCount == 0}" @click="checkedOut">Checkout</a>
              </div>
            </div>
          </div>
        </div>
