      ...
      <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="md-modal modal-msg md-modal-transition" :class="{'md-show': loginModalFlag}" >
          <div class="md-modal-inner">
              <div class="md-top">
                <div class="md-title" @click="loginModalFlag=true">Login</div>
                <div class="md-close"  @click="loginModalFlag=false">Close</div>
              </div>
              <div class="md-content">
                <div class="confirm-tips">
                  <div class="error-wrap">
                    <div class="error error-show" v-show="errorTip">用户名或则密码错误</div>
                  </div>
                  <ul>
                    <li class="regi_form_input">
                      <i class="icon IconPeopler"></i>
                      <input type="text" tabindex="1" name="loginname" v-model="userName" class="regi_login_input regi_login_input_left" placeholder="用户名">
                    </li>
                    <li class="regi_form_input noMargin">
                      <i class="icon IconPwd"></i>
                      <input type="password" tabindex="2" name="password" v-model="userPwd" class="regi_login_input regi_login_input_left" placeholder="密码" @keyup.enter="login">
                    </li>
                  </ul>
                </div>
